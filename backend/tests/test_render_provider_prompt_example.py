            ...
            capture_path.write_text(
                "\n".join(
                    [
                        ...
                        '{"agent_id": "agt_001", "display_name": "Socrates", "topic": "Old", "prompt": "old prompt", "captured_at": "2026-05-08T10:00:00Z", "provider_url": "https://api.example.com/v1", "model_id": "demo-model", "temperature": 0.6, "max_tokens": 200, "context_messages": [], "vector_context": [], "provider_request": {"request_url": "https://api.example.com/v1/chat/completions", "body": {"model": "demo-model", "messages": [{"role": "user", "content": "old prompt"}], "temperature": 0.6, "max_tokens": 200, "top_p": 0.95, "stream": false}}}',
                        '{"agent_id": "agt_001", "display_name": "Socrates", "topic": "Should AI replace teachers?", "prompt": "new prompt", "captured_at": "2026-05-09T12:00:00Z", "provider_url": "https://api.example.com/v1", "model_id": "demo-model", "temperature": 0.7, "max_tokens": 256, "context_messages": [{"turn_number": 1}], "vector_context": [{"id": "chunk-1"}], "provider_request": {"request_url": "https://api.example.com/v1/chat/completions", "body": {"model": "demo-model", "messages": [{"role": "user", "content": "new prompt"}], "temperature": 0.7, "max_tokens": 256, "top_p": 0.95, "stream": true, "stream_options": {"include_usage": true}}}}',
                    ]
                ),
                encoding="utf-8",
            )
